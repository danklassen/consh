    ...
    public function translateFromEditMode($text) {
        ...
        $text = preg_replace_callback(
            '/{CCM:FID_DL_([0-9]+)}/i',
            array('{{ControllerName}}', 'replaceDownloadFileIDInEditMode'),
            $text);
    ...
    public function translateFrom($text) {
        ...
        $text = preg_replace_callback(
            ...
            array('{{ControllerName}}', 'replaceImageID'),
            $text);
        ...
        $text = preg_replace_callback(
            '/{CCM:FID_DL_([0-9]+)}/i',
            array('{{ControllerName}}', 'replaceDownloadFileID'),
            $text);
